function MMT_2020_saukrs_laborinis_nr_2b
    ...
    grid on;
    title('Funkcijos y = a/x + b aproksimacija ją ištiesinant');
    legend( ...
        'Pateikti duomenys', ...
        'Aproksimacija su operatorium "\\"', ...
        'Aproksimacija su lsqcurvefit()' ...
    );

    disp(['lscurvefit() gauna lygiai tokius pačius tiesės' ...
        'koeficientus kaip ir A\y, todėl jų grafiką y_lscf1' ...
