...
+
```
osboxes@ldvm1:/usr/local/src/daq-2.0.7$ sudo apt-get autoremove libdaq2 libdaq-dev
[sudo] password for osboxes: 
Reading package lists... Done
Building dependency tree       
Reading state information... Done
The following packages will be REMOVED:
  libdaq-dev libdaq2 oinkmaster snort snort-common snort-common-libraries snort-rules-default
  0 upgraded, 0 newly installed, 7 to remove and 154 not upgraded.
  After this operation, 7,703 kB disk space will be freed.
  Do you want to continue? [Y/n] y
  (Reading database ... 198493 files and directories currently installed.)
  Removing libdaq-dev (2.0.4-3build2) ...
