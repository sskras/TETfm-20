...
Pirmosios šios savybės išplaukia iš **griežtai lokalios** Host nodų **talpyklinės architektūros**. <<23>>
...
Guest OS valdymas konverguotas -- ir HVMai, ir OS VMai (konteineriai) valdomi vienu įrankiu.
