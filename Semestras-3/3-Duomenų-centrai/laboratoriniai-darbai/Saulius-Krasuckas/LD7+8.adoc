...
* **KVM** (gana senos Linux 2.6.34 versijos VMM + senos _Qemu_ 0.14.1 versijos emuliatoriaus portas, 2011 m.);  <<21>> psl. 5 + 14
 ** Gana paplitęs VM mechanizmas / interfeisas;
 ** Neleidžia plėsti VM talpos (tenka kurti iš naujo);
