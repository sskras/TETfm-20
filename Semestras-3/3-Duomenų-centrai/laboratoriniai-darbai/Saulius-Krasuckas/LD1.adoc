...
. Dviejų DC parinkimas veikimui _Active-Active_ poroje

* Kriterijais renkuosi:
  - tinklo ir maitinimo patikimumus, 
  - L2 sujungimo galimybę, 
  - kuo didesnį atstumą tarp DC (_Georedundancy_).
* *DLC* DC atmetu, nes jis minimas kaip https://www.datacenterjournal.com/data-centers/lithuania/vilnius/#:~:text=Non-Neutral%20Vilnius%20Data%20Centers[Non-neutral DC (Carrier-wise?)]  +
(Ar tai tiesa?)
