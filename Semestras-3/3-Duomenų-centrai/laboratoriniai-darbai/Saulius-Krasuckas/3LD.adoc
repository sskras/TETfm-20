...
Vienintelė informacija, kurios reikia visos sistemos vėsinimo apkrovai nustatyti, yra kelios lengvai prieinamos vertės, pavyzdžiui: grindų plotas kvadratiniais metrais ir vardinės elektros sistemos galia.
