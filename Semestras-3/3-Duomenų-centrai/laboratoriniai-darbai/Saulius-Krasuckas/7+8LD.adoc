...
- Solaris/illumos projektuotas didesniam saugumui nei Linux, ir tai juntama
- Palaiko labai įvairius Storage backend-us
- ZFS privalumai: akimirsniniai klonai, šifravimas (kartais ir deduplikacija)
- PCI pass-through
...
- kiek vėlokai žengė į rinką (2011-2013 m.)
- valdoma per CLI, JSON ir truputį YAML (norint GUI reiktų naudoti Triton)
- Marketingo strategija dar tik kuriama, kinta (kitur stipresnės adminų ir jūzerių bendruomenės)

- VGA tik per VNC?

https://docs.google.com/document/d/1PFUmz6XpTVAGkq5dBe8uaBFV2Y4i-uR88AuiCLIRxIQ/edit
- kuriamas VM Cold/Warm/Live Migration
