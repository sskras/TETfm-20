...
[.text-left]
=== Užduotis nr. 1: "*Launch Single Node Kubernetes Cluster*"
...
[.text-left]
=== Užduotis nr. 2: "*Deploy containers using Kubectl*"
...
[.text-left]
=== Užduotis nr. 4: "*Deploy Guestbook example (Web App) on Kubernetes*"
...
-- veikia 3 valdikliai, 3 paslaugos ir 6 „ankštys“.
      ...
      . patikrinau paslaugos veikimą iš išorinio interneto -- veikia puikiai;
