...
Taip pat yra ir galimybė keičiantis konfigūracijai šiuos objektus atnaujinti bei perdiegti į klasterį iš naujo.


  * Žingsnis 3.1: *įdiegimo kūrimas*

    - automatinis _Shell_ startas:
+
----
