...
. Faile `views/index.tpl` laikomas šakninio puslapio šablonas.
...
. Sukurkite naują direktoriją, o joje patalpinkite `Dockerfile`, skirtą _Docker_ atvaizdžio sukūrimui, iš kurio startuos aplikacija (_Web_-servisas).
+
----
$ mkdir ~/src
$ cd ~/src
