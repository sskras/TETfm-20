...
Du mazgai (fizinis ir VM) yra skirti sysadminams,
o dar trys mazgai skirti DC tinklų ir TelCo tinklų administratoriams.

Į šiuos mazgus administratoriai įprastai jungiasi iš savo KDV (kompiuterinių darbo vietų).
KDV yra nešiojamieji kompiuteriai su Windows OS, 
...
KDV mašinos (o gal ir vartotojo) autentifikavimui naudojamas integruotas sertifikatas.
