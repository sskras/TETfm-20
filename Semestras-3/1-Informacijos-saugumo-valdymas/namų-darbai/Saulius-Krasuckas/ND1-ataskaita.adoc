...
Tačiau dėl savo CLI valdymo sąsajos ji irgi priskirta valdyti *nix sysadminams.
...
bet ir į tų IS mašinų fizinio valdymo (angl. _Management_) interfeisus: HP iLO, Dell DRAC, IBM IMM, HP MP, Sun/Oracle ALOM/ILOM/XSPF.
...
ugniasienėse yra sukurtos prieigos iš Bastionų ISį beveik visas *nix ir OpenVMS mašinas
