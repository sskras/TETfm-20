...
Šioje IS vartotojų (ar naudotojų?) paskyros yra lokalios, statinės ir yra kuriamos rankiniu būdu.
Jos daugiausiai skirtos vadinamiesiems sysadminams (serverių sistemų administratoriams).

Vienas mazgas yra fizinis, ir įrengtas duomenų centre tiesiogiai, fiziškai.
...
Du mazgai (fizinis ir VM) yra labiausiai skirti sysadminams,
